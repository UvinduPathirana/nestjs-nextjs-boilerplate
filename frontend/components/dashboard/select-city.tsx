...
export default function SelectCity({ selectedCity, setSelectedCity, setLoading }: SelectCityProps) {
    ...
    return (
        <div className="flex items-center space-x-2">
            <Select value={selectedCity?.city || ""} onValueChange={handleSelectChange} onOpenChange={handleToggleDropdown}>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This action cannot be undone. This will permanently delete the selected city.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                        <AlertDialogCancel>Cancel</AlertDialogCancel>
                        <AlertDialogAction onClick={handleDeleteCity} className="bg-red-600 text-white hover:bg-red-700">
                            Delete
                        </AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
            ...
            <AddCityDialog show={showAddCityDialog} onClose={() => setShowAddCityDialog(false)} onAddCity={handleAddCity} />
        </div>
    );
}
