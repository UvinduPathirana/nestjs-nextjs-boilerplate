...
export default function GeneralWhetherData({ weather }: GeneralWhetherDataProps) {
    if (!weather) {
                                    ...
                                    <div className="p-1">
                                        <Card className="flex flex-col items-center gap-4 p-4 rounded-lg bg-muted">
                                            <CardContent className="flex flex-col items-center justify-center gap-2">
                                                ...
                                                <Image src={makeAbsoluteUrl(hour.condition.icon)} alt={hour.condition.text} width={40} height={40} />
                                                <span className="text-gray-500 dark:text-gray-400">{hour.time.split(' ')[1]}</span>
                                            </CardContent>
                                        </Card>
                                    </div>
                                </CarouselItem>
