...
export default function ForecastWeek({ weather, loading }: GeneralWhetherDataProps) {
                        ...
                        <Card key={index} className="flex flex-col items-start gap-4 p-4">
                            <div className="flex w-full items-center justify-between">
                                ...
                                <div className="text-right">
                                    <div className="text-lg font-medium">{new Date(day.date).toLocaleDateString("en-US", { weekday: "long" })}</div>
